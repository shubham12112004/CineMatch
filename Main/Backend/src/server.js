...
async function startServer() {
  ...
  app.use((req, res, next) => {
    ...
    const isTmdbProxyRequest = req.path.startsWith('/api/tmdb');

    // Keep TMDB proxy publicly readable to avoid frontend CORS failures across Vercel domains.
    if (isTmdbProxyRequest) {
